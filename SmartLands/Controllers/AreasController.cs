...
namespace SmartLands.Controllers
{
    public class AreasController : Controller
    {
        ...
        public AreasController(LandslideDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AreaId,Name,Location")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AreaId,Name,Location")] Area area)
        {
            if (id != area.AreaId)
            {
                return NotFound();
